...
| 身份根 | `prisiragent-browser/agent/identity.mojom` | DeriveKey("forum-sign") + SignWith 薄壳转发目标 |
| 可插拔签名模式 | `prisiragent-browser/mixin/group.html:197-242` | 本目录 forum_client.js 直接复刻 |
...
2. 起静态服务: `cd prisiragent-browser/forum && python -m http.server 18940`
...
## 重编译挂接步骤(列入 §6.1 检查清单)
1. **复制**: `prisiragent-browser/forum/*.{html,js}` → `chrome/browser/resources/prisir/forum/`
