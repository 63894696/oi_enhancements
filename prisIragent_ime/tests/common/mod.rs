...
pub fn exe_path() -> PathBuf {
    PathBuf::from("C:/Users/Administrator/oi_enhancements/prisiragent_ime").join(EXE_REL)
}

pub fn dll_path() -> PathBuf {
    PathBuf::from("C:/Users/Administrator/oi_enhancements/prisiragent_ime").join("target/release/prisir_ime_tsf.dll")
}
