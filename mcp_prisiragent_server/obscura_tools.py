"""obscura_tools — Prisiragent 侧 Obscura 浏览器 MCP 暴露
...
跟 prisiragent 解耦:动态发现,启动失败 → 报错给上层,不影响其他 tools
"""
...
class ObscuraClient:
    ...
    single-process Prisiragent usage that's fine; Obscura's lib internally keeps
