#!/usr/bin/env python3
"""vault_tools.py — Prisiragent MCP 工具:Obsidian vault 搜索 + 读取

集成位置: /c/Users/Administrator/oi_enhancements/mcp_prisiragent_server/server.py
...
def _everything_search(query: str, path: str | None = None, ext: str | None = None, limit: int = 10) -> list[dict]:
    ...
    req = urllib.request.Request(url, headers={"User-Agent": "prisiragent-vault/1.0"})
    try:
