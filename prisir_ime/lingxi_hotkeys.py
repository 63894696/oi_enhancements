...
# 配色【深色柔和版 2026-08-19】
# ============================================================
# 背景不用纯黑(生硬),用带蓝灰调的软深色(Tailwind slate 风),三法悬浮球/候选窗统一。
COLORS = {
    "bg": "#0f172a",          # 悬浮球/候选窗主底(slate-900,黑里透蓝)
    "bg2": "#1e293b",         # 内圈/面板分层(slate-800)
    "border": "#334155",      # 描边(slate-700)
    "text": "#e2e8f0",        # 主文字(slate-200)
    "text_dim": "#94a3b8",    # 次文字(slate-400)
    "gold": "#e8b458",        # 品牌暖金(沿用,与翻译插件一致)
    "ready": "#3fbf7f",       # 绿=就绪/已激活
    "recording": "#2ee06a",   # 亮绿=语音录音中(高饱和醒目)
    "busy": "#e8b23c",        # 黄=识别中/处理中
    "error": "#e05252",       # 红=故障
}
