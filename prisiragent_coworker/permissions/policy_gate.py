...
"""Prisiragent Coworker -- P0-3 PolicyGate compatibility layer.
...
Anti-flattery boundary (see plan §3.1 / §8.1.1):
    ...
    - The gate NEVER imports ``prisiragent.policy`` (the legacy engine is
...
from prisiragent_coworker.permissions.audit import AuditDecision, AuditSink
...
class LegacyPolicyEngine(Protocol):
    """Duck-typed contract for prisiragent.policy.PolicyEngine (P0-3).
