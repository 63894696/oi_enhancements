...
#   - Renamed package openworker -> prisiragent_coworker; replaced upstream
...
"""Permissions package for Prisiragent Coworker (W2-1 + P0-3 gate).
...
from prisiragent_coworker.permissions.policy_gate import (
    LegacyPolicyEngine,
    PolicyGate,
    PolicyGateMode,
    VerdictDiff,
