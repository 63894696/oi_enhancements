...
#   Upstream commit:  not present (W3-1 is Prisiragent-only)
...
"""Prisiragent Coworker -- W3-1 shadow-mode verdict-diff consistency analyzer.

This module consumes an injected iterable of ``kind="permission"``
audit-envelope dicts (the serialized form of
:class:`~prisiragent_coworker.permissions.audit.AuditDecision`) and produces:
