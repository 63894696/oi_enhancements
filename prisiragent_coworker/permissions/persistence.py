...
#     (15min, tightened from upstream 1h per Prisiragent P2-10 risk profile).
...
``rule_id`` to ``StandingRule``. Upstream used SQLite; Prisiragent Coworker
...
class StandingRule:
    ...
    Attributes:
        ...
        granted_by: Identity that created the rule ("user",
            "prisiragent.admin", "policy.default", etc.).
...
class OIagentCoworkerStandingRuleStore:
    ...
    def __init__(
        ...
        from prisiragent_coworker.permissions.audit import AuditDecision
    ...
    def set_audit_sink(self, sink: object | None) -> None:
        ...
        See ``prisiragent_coworker.permissions.audit`` for the facade contract.
        """
...
def make_default_rule(
    ...
    *,
    ...
    """
    from prisiragent_coworker.permissions.engine import DEFAULT_STANDING_RULE_TTL_S
