"""prisiragent_context.py — 壳端上下文窗口管理(移植自 NTP ctx.js + observation masking)。

两档(用户拍板 1+2, 2026-08-20, 详见 docs/prisiragent-shell-context-window-management-2026-08-20.md):
...
CONTEXT_WINDOWS = {
    ...
    "gpt-4o-mini": 128000,
    "gpt-4-turbo": 128000,
    # 2026-09-05:1M 上下文档(对齐顶级模型,用户拍板改阈值触发点)。
    # claude-5 系(opus/sonnet/fable)、gpt-5、gemini-2.5-pro 按 1M 标称保守取 1M。
    "claude-opus-5": 1000000,
    "claude-sonnet-5": 1000000,
    "claude-fable-5": 1000000,
    "claude-opus": 200000,        # claude-4.x 及更早 opus(200k)
...
# prisiragent_web 里优先调模型,失败回退本规则式)。
